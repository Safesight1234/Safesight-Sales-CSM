...
(function () {
  ...
  function CSMTab({ ctx }) {
    ...
    // watchlist: contracts ending WITHIN the next 6 months that still have no
    // renewal status set (and aren't signed) — i.e. urgent, not yet actioned.
    ...
    return (
      <React.Fragment>
        ...
        <div className="grid g-2">
          <Card title="Ending within 6 months · no renewal status" count={`${noStatus.length} contract${noStatus.length !== 1 ? 's' : ''}`}>
